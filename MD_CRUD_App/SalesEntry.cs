...
namespace MD_CRUD_App
{
  public partial class SalesEntry : Form
  {
    ...
    internal SalesMaster copy = new SalesMaster();
    ...
    void DataReset()
    {
      ...
      model = copy.Copy();
      salesDetailsBindingSource.DataSource = model.ItemList;
      txtSalesId.Text = model.SalesId.ToString();
      txtCustomerName.Text = model.CustomerName;

      //salesDate.Value = model.SalesDate;
      nmPaid.Value = model.PaidAmount;
      nmTotal.Value = model.TotalAmount;
      chkFullPaid.Checked = model.FullPaid;
    ...
    private void gridList_CellValueChanged(object sender, DataGridViewCellEventArgs e)
    {
      ...
      {
        decimal total = model.ItemList.Sum(i => i.ItemTotal);
        nmTotal.Value = total;
    ...
    private void chkFullPaid_CheckedChanged(object sender, EventArgs e)
    {

      nmPaid.ReadOnly = chkFullPaid.Checked;
      if(chkFullPaid.Checked)
      {
        nmPaid.Value = nmTotal.Value;
      }
    }
  }
}
